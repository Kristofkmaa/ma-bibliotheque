// Bibliothèque d'icônes SVG — pas d'emojis
...
export const IconBookmark = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export const IconBarcode = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M1 7h2M1 17h2M21 7h2M21 17h2"/>
  </svg>
)
...
export const IconLoader = ({ size = 20, color = 'currentColor' }) => (
...
export const IconSparkle = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export const IconTag = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export const IconGoogle = ({ size = 20 }) => (
  <svg width={size} height={size} viewBox="0 0 18 18">
    ...
    <path fill="#34A853" d="M9 18c2.43 0 4.47-.8 5.96-2.18l-2.6-2.01c-.76.53-1.78.9-3.36.9-2.57 0-4.76-1.73-5.54-4.07H.76v2.07A9 9 0 009 18z"/>
    <path fill="#FBBC05" d="M3.46 10.64A5.43 5.43 0 013.18 9c0-.56.1-1.1.28-1.64V5.29H.76A9 9 0 000 9c0 1.45.35 2.82.76 4.07l2.7-2.43z"/>
    <path fill="#EA4335" d="M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58A9 9 0 009 0C5.48 0 2.44 2.02.76 5.01L3.46 7.36C4.24 5.02 6.43 3.58 9 3.58z"/>
  </svg>
)
